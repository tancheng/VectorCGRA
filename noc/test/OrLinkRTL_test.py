...
from ..OrLinkRTL import OrLinkRTL
...
class TestHarness(Component):
  ...
  def construct(s, MsgType, src_msgs_0, src_msgs_1, src_msgs_2, sink_msgs,
    ...
    s.dut = OrLinkRTL(MsgType, 3, nbits_payload)
...
src_msgs_0 = [DataType(7,0,1), DataType(4,1), DataType(1,1), DataType(0,1), DataType(0,0)]
src_msgs_1 = [DataType(0,1,1), DataType(0,0), DataType(0,0), DataType(0,1), DataType(0,0)]
src_msgs_2 = [DataType(0,1,1), DataType(0,0), DataType(2,0), DataType(2,1), DataType(3,0)]
sink_msgs = [DataType(7,1), DataType(4,1), DataType(3,1), DataType(2,1), DataType(3,0)]

def test_simple():
  th = TestHarness(DataType, src_msgs_0, src_msgs_1, src_msgs_2,
                   sink_msgs, nbits_payload)
  run_sim(th)
