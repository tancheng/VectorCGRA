...
def test_multi_CGRA_systolic_2x2_2x2(cmdline_opts):
  ...
  activation_tensor_preload_data = [
      [
          ...
          CtrlPktType(0, 0, 0, 0, 0, ctrl_action = CMD_STORE_REQUEST, addr = 2, data = 3, data_predicate = 1),
          CtrlPktType(0, 0, 0, 0, 0, ctrl_action = CMD_STORE_REQUEST, addr = 3, data = 4, data_predicate = 1)
      ]
  ]
  ...
  src_opt_pkt = [
      ...
      [
          ...
          CtrlPktType(0,      0,  0,  0,    0,  CMD_CONFIG, 0,   OPT_LD_CONST, b1(0),
                      ...
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       TileInType(0), TileInType(0), TileInType(0), TileInType(0)],
                      # FU xbar to north tile(CGRA 2, tile2).
                      [FuOutType(1), FuOutType(0), FuOutType(0), FuOutType(0),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]
                      ),
          #           cgra_id src dst vc_id opq cmd_type    addr operation     predicate
      ...
      # CGRA 0, tile 1.
      [
          CtrlPktType(0, 0, 1, 0, 0, ctrl_action = CMD_CONST, data = 2),
          CtrlPktType(0, 0, 1, 0, 0, ctrl_action = CMD_CONST, data = 3),

          # LD_CONST indicates the address is a const.
          #           cgra_id src dst vc_id opq cmd_type    addr operation     predicate
          CtrlPktType(0,      0,  1,  0,    0,  CMD_CONFIG, 0,   OPT_LD_CONST, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       TileInType(0), TileInType(0), TileInType(0), TileInType(0)],
                      # FU xbar to north tile(CGRA 2, tile3).
                      [FuOutType(1), FuOutType(0), FuOutType(0), FuOutType(0),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]
                      ),
          #           cgra_id src dst vc_id opq cmd_type    addr operation     predicate
      ...
      # CGRA 2, tile 2.
      [
          CtrlPktType(2, 0, 2, 0, 0, ctrl_action = CMD_CONST, data = 2),

          CtrlPktType(2, 0, 2, 0, 0, CMD_CONFIG, 0, OPT_MUL_CONST, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                       # Forward data from south(CGRA 0, tile 0) to north (CGRA2, tile 0).
                      [TileInType(2), TileInType(0), TileInType(0), TileInType(0),
                       # Put data from south(CGRA 0, tile 0) to first inport of FU, to do OPT_MUL_CONST.
                       TileInType(2), TileInType(0), TileInType(0), TileInType(0)],
                       #                                         FU xbar to east tile(CGRA 2, tile3).
      ...
      # CGRA 2, tile 3.
      [
          CtrlPktType(2, 0, 3, 0, 0, ctrl_action = CMD_CONST, data = 4),

          CtrlPktType(2, 0, 3, 0, 0, CMD_CONFIG, 0, OPT_MUL_CONST_ADD, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                       # Forward data from south(CGRA 0, tile 0) to north (CGRA2, tile 0).
                      [TileInType(2), TileInType(0), TileInType(0), TileInType(0),
                       # Put data from south(CGRA 0, tile 1) to first inport of FU,
                       # put data from west(CGRA 2, tile 2) to second inport of FU,
                       # to do OPT_MUL_CONST_ADD.
                       TileInType(2), TileInType(3), TileInType(0), TileInType(0)],
                      #                                          FU xbar to east tile(CGRA 3, tile2).
                      [FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(1),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]),
      ...
      # CGRA 2, tile 0.
      [
          CtrlPktType(2, 0, 0, 0, 0, ctrl_action = CMD_CONST, data = 6),

          CtrlPktType(2, 0, 0, 0, 0, CMD_CONFIG, 0, OPT_MUL_CONST, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       # Put data from south(CGRA 2, tile 2) to first inport of FU, to do OPT_MUL_CONST.
                       TileInType(2), TileInType(0), TileInType(0), TileInType(0)],
                       #                                         FU xbar to east tile(CGRA 2, tile 1).
                      [FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(1),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]),
          CtrlPktType(2, 0, 0, 0, 0, CMD_LAUNCH, 0, OPT_NAH, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
      ...
      # CGRA 2, tile 1.
      [
          CtrlPktType(2, 0, 1, 0, 0, ctrl_action = CMD_CONST, data = 8),

          CtrlPktType(2, 0, 1, 0, 0, CMD_CONFIG, 0, OPT_MUL_CONST_ADD, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       # Put data from south(CGRA 2, tile 3) to first inport of FU,
                       # put data from west(CGRA 2, tile 0) to second inport of FU,
                       # to do OPT_MUL_CONST_ADD.
                       TileInType(2), TileInType(3), TileInType(0), TileInType(0)],
                       #                                         FU xbar to east tile(CGRA 3, tile 0).
                      [FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(1),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]),
      ...
      # CGRA 3, tile 0 and tile 2 get data from CGRA 2 then store into mem.
      # CGRA 3, tile 0.
      [
          # todo
          # store into mem

          # Mem addr to store data.
          CtrlPktType(3, 0, 0, 0, 0, ctrl_action = CMD_CONST, data = 96),
          CtrlPktType(3, 0, 0, 0, 0, ctrl_action = CMD_CONST, data = 97),

          CtrlPktType(3, 0, 0, 0, 0, CMD_CONFIG, 0, OPT_STR_CONST, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       # From west (CGRA 2, tile 1).
      ...
      # CGRA 3, tile 2.
      [
          CtrlPktType(3, 0, 2, 0, 0, ctrl_action = CMD_CONST, data = 98),
          CtrlPktType(3, 0, 2, 0, 0, ctrl_action = CMD_CONST, data = 99),

          CtrlPktType(3, 0, 2, 0, 0, CMD_CONFIG, 0, OPT_STR_CONST, b1(0),
                      [FuInType(0), FuInType(0), FuInType(0), FuInType(0)],
                      [TileInType(0), TileInType(0), TileInType(0), TileInType(0),
                       # From west (CGRA 2, tile 3).
                       TileInType(3), TileInType(0), TileInType(0), TileInType(0)],
                      [FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0),
                       FuOutType(0), FuOutType(0), FuOutType(0), FuOutType(0)]),
  ...
  src_query_pkt = \
      [
          CtrlPktType(0, 0, 0, 0, 0, ctrl_action = CMD_LOAD_REQUEST, addr = 96),
          CtrlPktType(0, 0, 0, 0, 0, ctrl_action = CMD_LOAD_REQUEST, addr = 97),
      ]
  ...
  expected_sink_out_pkt = \
      [
          ...
          CtrlPktType(0, 0, num_tiles, 0, 0, ctrl_action = CMD_COMPLETE),
          # Expected updated value.
          CtrlPktType(3, 0, 0, 0, 0, ctrl_action = CMD_LOAD_RESPONSE, addr = 96, data = 0x0a,
                      data_predicate = 1),
          CtrlPktType(3, 0, 0, 0, 0, ctrl_action = CMD_LOAD_RESPONSE, addr = 97, data = 0x0b,
                      data_predicate = 1),
      ]
