...
expected_to_noc_pkts = [
                   # src  dst src_x src_y dst_x dst_y src_tile dst_tile   opq vc                 cmd
    InterCgraPktType(0,   0,  0,    0,    0,    0,    0,       num_tiles, 0,  0, CgraPayloadType(CMD_LOAD_REQUEST,  data = DataType(0,   0), data_addr = 1)),
    ...
    InterCgraPktType(0,   2,  0,    0,    2,    0,    0,       num_tiles, 0,  0, CgraPayloadType(CMD_LOAD_REQUEST,  data = DataType(0,   0), data_addr = 8)),
    ...
    InterCgraPktType(0,   3,  0,    0,    3,    0,    0,       num_tiles, 0,  0, CgraPayloadType(CMD_LOAD_REQUEST,  data = DataType(0,   0), data_addr = 13)),
