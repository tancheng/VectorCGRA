...
class InclusiveDivRTL(Fu):
  ...
  def construct(s, CtrlPktType, num_inports, num_outports, latency = 2, vector_factor_power = 0):

    super(InclusiveDivRTL, s).construct(CtrlPktType, num_inports, num_outports, latency, vector_factor_power)
