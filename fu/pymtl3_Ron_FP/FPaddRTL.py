...
class FPadd( VerilogPlaceholder, Component ):
  ...
  def construct( s, expWidth = 5, sigWidth = 11 ):
    ...
    s.set_metadata( VerilogPlaceholderPass.src_file, srcdir + 'FPadd.sv' )
    s.set_metadata( VerilogPlaceholderPass.top_module, 'FPadd_plain' )
