...
def test_elaborate(cmdline_opts):
  ...
  src_opt       = [ ConfigType( OPT_MUL_CONST, b1(1), pick_register ),
                    ConfigType( OPT_MUL,       b1(1), pick_register ),
                    ConfigType( OPT_MUL_CONST, b1(1), pick_register ) ]
...
def test_mul():
  ...
  src_opt       = [ ConfigType( OPT_FMUL_CONST, b1(1), pick_register ),
                    ConfigType( OPT_FMUL,       b1(1), pick_register ),
