...
def test_elaborate( cmdline_opts ):
  ...
  dut = FaddRTL( DataType, PredicateType, ConfigType,
                          num_inports, num_outports, data_mem_size, exp_nbits=4, sig_nbits=11 )
...
def test_add_basic():
  ...
  FuInType      = mk_bits( clog2( num_inports + 1 ) )
  pickRegister  = [ FuInType( x+1 ) for x in range( num_inports ) ]
  src_in0       = [ f2b(1, 1), f2b(7, 1), f2b(4, 1) ]
  src_in1       = [ f2b(2, 1), f2b(3, 1), f2b(1, 1) ]
  src_predicate = [ PredicateType(1, 0), PredicateType(1, 0), PredicateType(1, 1) ]
  src_const     = [ f2b(5, 1), f2b(0, 0), f2b(7, 1) ]
  sink_out      = [ f2b(6, 0), f2b(4, 0), f2b(11, 1) ]
  src_opt       = [ ConfigType( OPT_ADD_CONST, b1( 1 ), pickRegister ),
                    ConfigType( OPT_SUB,       b1( 1 ), pickRegister ),
                    ConfigType( OPT_ADD_CONST, b1( 1 ), pickRegister ) ]
