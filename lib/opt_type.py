...
OPT_SYMBOL_DICT = {
  ...
  OPT_VEC_REDUCE_ADD_GLOBAL      : "(vall+global)",
  OPT_VEC_REDUCE_MUL_GLOBAL      : "(vall*global)",
  OPT_VEC_REDUCE_ADD_BASE_GLOBAL : "(vall+base_global)",
  OPT_VEC_REDUCE_MUL_BASE_GLOBAL : "(vall*base_global)",
