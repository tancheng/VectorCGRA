...
(
  ...
  IntraCgraPacket_4_2x2_16_8_2_CgraPayload pkt;
  integer file_handle;
...
function automatic IntraCgraPacket_4_2x2_16_8_2_CgraPayload make_intra_cgra_config_pkt
(
  input logic [4:0] src,
  input logic [4:0] dst,
  input logic [5:0] cmd,
...
function automatic IntraCgraPacket_4_2x2_16_8_2_CgraPayload make_intra_cgra_config_pkt_w_data
(
  input logic [4:0] src,
  input logic [4:0] dst,
  input logic [5:0] cmd,
...
function automatic logic [$bits(IntraCgraPacket_4_2x2_16_8_2_CgraPayload)-1:0] logic_pkt (IntraCgraPacket_4_2x2_16_8_2_CgraPayload p);
  logic_pkt = {
