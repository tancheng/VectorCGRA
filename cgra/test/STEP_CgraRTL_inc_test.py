...
class TestHarness(Component):
    def construct(s,
        ...
        s.st_axi_pkts = [AxiStSourceRTL(DataType, [], 0, 0) for _ in range(num_st_ports)]
...
def init_param():
    ...
    ### Full Bitstream Pkt ###
    bitstreams = [
        CfgBitstreamType(bitstream=(inc_row + no_op_row * (num_tile_rows - 1))),
    ]
