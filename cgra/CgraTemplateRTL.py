...
class CgraTemplateRTL(Component):
  ...
  def construct(s, DataType, PredicateType, CtrlPktType, CtrlSignalType,
    ...
    s.data_mem.recv_raddr[dataSPM.getNumOfValidReadPorts()] //= s.controller.send_to_master_load_request_addr
    s.data_mem.recv_waddr[dataSPM.getNumOfValidWritePorts()] //= s.controller.send_to_master_store_request_addr
    s.data_mem.recv_wdata[dataSPM.getNumOfValidWritePorts()] //= s.controller.send_to_master_store_request_data
