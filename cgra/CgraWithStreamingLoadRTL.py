...
from ..tile.TileWithStreamingLoadRTL import TileWithStreamingLoadRTL
from ..lib.util.data_struct_attr import *
from ..lib.messages import *
from ..lib.util.common import *


class CgraWithStreamingLoadRTL(Component):
  ...
  def construct(s, CgraPayloadType,
    ...
    # Components
    s.tile = [TileWithStreamingLoadRTL(CtrlPktType,
                                       ctrl_mem_size,
