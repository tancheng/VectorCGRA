...
def test_const_queue(cmdline_opts):
  ...
  read_addr = [
               ...
               [NonblockingAddrType(0, 0, 0), NonblockingAddrType(44, 1, 1), NonblockingAddrType(44, 1, 1), NonblockingAddrType(1, 0, 0), NonblockingAddrType(2, 0, 0)], # Tile 0
               #Cycle0, out of range, miss     Cycle1, in range, hit          Cycle2, in range, hit          Cycle3, out of range, hit      Cycle4, in range, hit
               [NonblockingAddrType(58, 2, 2), NonblockingAddrType(16, 0, 0), NonblockingAddrType(17, 0, 0), NonblockingAddrType(58, 2, 2), NonblockingAddrType(18, 0, 0)], # Tile 1
              ]
  ...
  read_data = [
               ...
               [DataType(0xa6, 1), DataType(0x00, 0), DataType(0xabcd, 1), DataType(0xa7, 1), DataType(0xa8, 1)], # Tile 0
