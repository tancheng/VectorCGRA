...
def init_param():
    ...
    data_in_msgs = [
        # North
        [DataType(i+1) for i in range(num_tests)],
        # South
        [DataType(i) for i in range(num_tests)],
        # West
        [],
        # East
        [],
    ...
    data_out_msgs = [
        # North
        [DataType(2*i +1) for i in range(num_tests)],
        # South
        [],
        # West
        [],
    ...
    pred_in_rf_msgs = [ Bits1(i % 2 == 0) for i in range(num_tests) ]
